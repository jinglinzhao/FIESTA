...
# Interpolate CCF with CubicSpline to simulate the shift of a real spectrum
# Does not work well probably due to interpolation
# Stopped developing!
...
hdulist     = fits.open(FILE[0])					# only use the first file as demo
CCF_tpl     = 1 - hdulist[0].data 					# flip the line profile
cs 			= CubicSpline(X, CCF_tpl)
ccf_tpl		= CCF_tpl[idx]
